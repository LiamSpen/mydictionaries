...
# The sample dictionary above in this case is class, which has one key. Student is another dictionary that has two keys. Last is the marks dictionary which has two keys as well.
