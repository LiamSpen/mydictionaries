...
for i in ProduceDictionary:
    calctotal = round(float(ProduceDictionary[i]['cost']) *
                      float(ProduceDictionary[i]['amt_sold']), 2)
    if calctotal != ProduceDictionary[i]['total']:
        print(f"Produce Name: {i}")
        print(f"Calculated Total: {calctotal}")
        print(f"Stated Total: {ProduceDictionary[i]['total']}\n")
